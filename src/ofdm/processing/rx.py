...
def unpack_rx_packet(ofdm_conf:OFDMConfig, rx_raw:np.ndarray, sync_ref_time:np.ndarray, tx_pilot_ref:np.ndarray, n_data_symbols:int, sim:bool = False)->np.ndarray:
    """  
    ...
    total_symbols = 1 + 1 + n_data_symbols # (1 and 1 for Sync and Pilot) This needs to up updated eventually for dynamic 
    ...
    return demodulated_data, refined_packet_start

#TODO: The logic of unpacking the actual packet and reading the preparing the data should be seperated
