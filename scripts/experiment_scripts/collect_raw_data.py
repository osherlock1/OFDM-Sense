...
# --------- MODIFY --------------
EXPERIMENT_NAME = (
    "rj_virtual_multilateration_300"  # CHOOSE NAME OF EXPERIMENT TO BE RUN
)
ROAMING_DEVICES = [
    "RX4ch1"
]  # NAME OF DEVICE THAT IS MOVED (WILL ASK FOR POSITIONS EACH RUN)
FIXED_DEVICES = [
    "ANCHORch0",
    "TX",
]  # NAME OF DEVICES THAT ARE FIXED (WILL ONLY ASK ONCE PER EXPERIMENT)
# -------------------------------
...
def get_coordinate_input():
    ...
    x = parse_measurement(("  X:  "))
    y = parse_measurement(("  Y:  "))
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="./experiments",
        help="root directory where experiment data will be saved",
    )
