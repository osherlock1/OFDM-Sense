...
def main():
    ...
    parser.add_argument(
        "--tx_file",
        type=str,
        default="data_files/rand_ofdm_packet.dat",
        help="File USRP will read from",
    )
    parser.add_argument(
        "--rx_file",
        type=str,
        default="data_files/rand_ofdm_packet_rx.dat",
        help="File USRP will write to",
    )
    parser.add_argument(
        "--ref_path",
        type=str,
    ...
    parser.add_argument(
        "--channel", "-c", type=str, help="subdev specification: (A:0 B:0) default"
    )
    ...
    parser.add_argument(
        "--tx_channel_idx",
        type=str,
        help="Specify the channel to send from (based on subdev specification)",
    )
    parser.add_argument(
        "--rx_channel_idx",
        type=str,
        help="Specify the channel to recieve from (based on subdev specification)",
    )
